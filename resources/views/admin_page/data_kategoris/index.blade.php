...
<div class="bg-white rounded-xl shadow-[0px_4px_20px_rgba(0,0,0,0.05)] border border-gray-100 p-6">
    ...
    <div class="flex flex-col md:flex-row justify-end items-center gap-4 mb-6">
        <a href="{{ route('kategoris.create') }}" class="bg-yum-primary text-sm text-white px-6 py-2 rounded-lg font-semibold hover:bg-yum-dark transition flex items-center shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
                ...
                <tr class="hover:bg-gray-50/50 transition group">
                    ...
                    <td class="px-4 py-3 text-center">
                        <div class="flex items-center justify-center space-x-2">
                            <a href="{{ route('kategoris.edit', $kategori->id) }}" class="p-2 bg-yellow-50 text-yellow-600 rounded-lg hover:bg-yellow-100 transition" title="Edit">
