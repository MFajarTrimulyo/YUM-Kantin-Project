                ...
                <div class="bg-gray-50 px-6 py-4 border-b border-gray-100 flex justify-between items-center">
                    ...
                    <div class="text-right">
                        ...
                        <div class="flex items-center justify-end gap-2 mt-1">
                            ...
                            class="flex items-center gap-1 bg-white border border-gray-200 text-gray-600 px-3 py-1.5 rounded-lg text-xs font-bold hover:bg-yum-primary hover:text-white hover:border-yum-primary transition shadow-sm">
