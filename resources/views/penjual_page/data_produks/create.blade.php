...
<div class="max-w-3xl mx-auto bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-8">
    <h2 class="text-xl font-bold text-gray-800 mb-6">Tambah Menu Baru</h2>
    ...
    <form action="{{ route('produk.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 gap-6">
            ...
            <div>
                ...
                <input type="text" name="nama" value="{{ old('nama') }}" class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:border-yum-primary focus:ring-2 focus:ring-yum-primary/20 outline-none" placeholder="Contoh: Nasi Goreng Spesial">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="stok" value="{{ old('stok', 0) }}" class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:border-yum-primary focus:ring-2 focus:ring-yum-primary/20 outline-none">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="harga" value="{{ old('harga') }}" class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:border-yum-primary focus:ring-2 focus:ring-yum-primary/20 outline-none" placeholder="0">
                    <p class="text-xs text-gray-400 mt-1">Contoh: 15000 (Rp 15.000)</p>
                ...
                <div>
                    ...
                    <input type="number" name="harga_diskon" value="{{ old('harga_diskon', 0) }}" class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:border-yum-primary focus:ring-2 focus:ring-yum-primary/20 outline-none" placeholder="0 jika tidak ada">
            ...
            <div>
                ...
                <textarea name="deskripsi" rows="3" class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:border-yum-primary focus:ring-2 focus:ring-yum-primary/20 outline-none">{{ old('deskripsi') }}</textarea>
            </div>

            {{-- Pilihan Rasa --}}
            <div class="col-span-1">
                <label class="block text-sm font-bold text-gray-700 mb-2">Varian Rasa / Toping</label>
                <input type="text" name="pilihan_rasa" value="{{ old('pilihan_rasa') }}" 
